...
Cron job 9h sáng theo timezone từng user (Supabase pg_cron + Edge Function) gọi lại scheduling engine (issue 003) để reschedule các task chưa hoàn thành/task mới trong ngày, rồi push kết quả qua APNs/FCM.
...
- [ ] Có log/record lần reschedule (phục vụ issue 006 Daily Reflection và issue 012 buffer động).
